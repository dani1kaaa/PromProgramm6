 ...
 * @author jasic
 */
public class BDV1_LAB6 extends javax.swing.JFrame {
    ...
    class TThread1 extends Thread { // Поток запуска MS Excel
        ...
        public void run() {
            ...
            try {
                modifData(dir + "temp.xls", dir + "kaspiXLS.xls", jTextField1.getText(),
                ...
                if (System.getProperty("os.name").equals("Linux")
                    ...
                    new ProcessBuilder("xdg-open", dir + "kaspiXLS.xls").start();
                } else {
                    Desktop.getDesktop().open(new File(dir + "kaspiXLS.xls")); // Запуск отчета в MS Excel
                }
            } catch (Exception ex) {
...
//    }
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(10, 40, 150, 20);

        jLabel2.setText("Комментарий");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(10, 130, 150, 20);
        ...
        jTextField1.setBounds(170, 40, 170, 30);
        ...
        jButton2.setBounds(250, 180, 110, 22);

        jLabel3.setText("Номер получателя");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(10, 70, 150, 20);

        jLabel4.setText("Сумма");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(10, 100, 150, 20);
        getContentPane().add(jTextField3);
        jTextField3.setBounds(170, 100, 170, 30);
        getContentPane().add(jTextField4);
        jTextField4.setBounds(170, 130, 170, 30);

        jLabel5.setText("Kaspi Gold перевод");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(140, 10, 150, 20);

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BDV1_lLLAB6/Kaspi.png"))); // NOI18N
        getContentPane().add(jLabel6);
        jLabel6.setBounds(0, 0, 400, 250);

        setSize(new java.awt.Dimension(409, 290));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            String xlsxFileName = new File(".").getAbsoluteFile().getParentFile().getAbsolutePath()
                    + System.getProperty("file.separator") + "kaspiXLSX.xlsx";
//            writeXLSXFile(xlsxFileName);
            ...
            Desktop.getDesktop().open(new File("kaspiXLSX.xlsx"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BDV1_LAB6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
